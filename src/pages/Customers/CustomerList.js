        ...
        {numSelected > 0 ? (
          ...
          <>
            ...
            <Tooltip title="Thêm Khách Hàng">
              <Link style={{ textDecoration: "none" }} to="/manage/customers/create">
...
const CustomerList = () => {
  ...
  const emptyRows = page > 0 ? Math.max(0, rowsPerPage - listCustomer.length) : 0;
          ...
          >
            <Table sx={{ minWidth: 750 }} aria-labelledby="tableTitle">
              ...
              {listCustomer?.length <= rowsPerPage ? (
                <TableBody>
                  {stableSort(listCustomer, getComparator(order, orderBy)).map((row, index) => {
